...
# Configure logging
logging.basicConfig(filename='/home/cdacea/north_GH/PAR1_data.log',
                    level=logging.INFO,
...
Climatic_data_pathway = '/home/cdacea/north_GH/PAR1.csv'
...
try:
    with open(Climatic_data_pathway, mode='a', newline='') as csv_file:
        fieldnames = ['datetime', 'PAR_1 (umol.m-1.s-1)']
        ...
        while True:
            ...
            writer.writerow({'datetime': formatted_datetime, 'PAR_1 (umol.m-1.s-1)': PAR_intensity_1})
