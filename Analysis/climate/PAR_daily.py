...
csv_path = r'C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\mean_PAR_data.csv'
...
for date, group_data in zone_b_grouped.groupby('date'):
    ...
    plt.title(f'Daily PAR Zone B - {date}')
    plt.xlabel('Time')
    ...
    file_name = f'Daily_PAR_Zone_B_{date}.png'
    file_path = r'C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\plots\PAR\\' + file_name
...
for date, group_data in zone_c_grouped.groupby('date'):
    ...
    plt.title(f'Daily PAR Zone C - {date}')
    plt.xlabel('Time')
    plt.ylabel('PAR (umol.m-2.s-1)')
    ...
    file_name = f'Daily_PAR_Zone_C_{date}.png'
    file_path = r'C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\plots\PAR\\' + file_name
    plt.savefig(file_path)
    plt.close()
