...
csv_file_path = r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\mean_Humidity_data.csv"
...
plt.title('Humidity Zone B - {} to {}'.format(first_date, today_date))
plt.xlabel('DateTime')
plt.ylabel('RH (%)')
# Set y-axis limits
plt.ylim(30, 100)
plt.legend()
plt.grid(True)
plt.savefig(r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\plots\Humidity\Humidity_zone_b_{}_to_{}.svg".format(first_date, today_date))
plt.show()
...
plt.title('Humidity Zone C - {} to {}'.format(first_date, today_date))
plt.xlabel('DateTime')
plt.ylabel('RH (%)')
# Set y-axis limits
plt.ylim(30, 100)
plt.legend()
plt.grid(True)
plt.savefig(r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\plots\Humidity\Humidity_zone_c_{}_to_{}.svg".format(first_date, today_date))
plt.show()
