# -*- coding: utf-8 -*-
"""
Created on Wed Feb 21 11:23:32 2024
...
ax.set_title('Daily Humidity Stats for Zones B and C')
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\plots\Humidity\Daily_Average_Mean_Zone_B_and_C.svg")
# Show the plot
plt.show()
