...
csv_file_path = r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\mean_SolarRadiation_data.csv"
...
plt.title('Solar radiation Zone B - {} to {}'.format(first_date, today_date))
plt.xlabel('DateTime')
plt.ylabel('Solar radiation (w.m-2)')
plt.legend()
plt.grid(True)
plt.savefig(r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\plots\Solar radiation\solar_radiation_zone_b_{}_to_{}.svg".format(first_date, today_date))
plt.show()
...
plt.title('Solar radiation - {} to {}'.format(first_date, today_date))
plt.xlabel('DateTime')
plt.ylabel('Solar radiation')
plt.legend()
plt.grid(True)
plt.savefig(r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\plots\Solar radiation\solar_radiation_zone_c_{}_to_{}.svg".format(first_date, today_date))
plt.show()
