...
csv_file_path = r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\mean_PAR_data.csv"
...
plt.title('PAR Zone B - {} to {}'.format(first_date, today_date))
plt.xlabel('DateTime')
plt.ylabel('PAR (umol.m-2.s-1)')
plt.legend()
plt.grid(True)
plt.savefig(r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\plots\PAR\PAR_zone_b_{}_to_{}.svg".format(first_date, today_date))
plt.show()
...
plt.title('PAR Zone C - {} to {}'.format(first_date, today_date))
plt.xlabel('DateTime')
plt.ylabel('PAR (umol.m-2.s-1)')
plt.legend()
plt.grid(True)
plt.savefig(r"C:\Users\bantanam\KAUST\CDA-CEA Team - Documents\CO2 misting - Cucumber trial\Data collection\Climatic_data\plots\PAR\PAR_zone_c_{}_to_{}.svg".format(first_date, today_date))
plt.show()
