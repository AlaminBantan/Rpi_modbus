...
ax = sns.boxplot(x=df['Date'].dt.date, y='# Fruits/plant', hue='Treatment', data=df, palette=custom_palette)
plt.title('Number of Fruits per Plant')
plt.xlabel('Date')
plt.ylabel('# Fruits/plant')
...
output_filename = "sample_fruits_per_plant.svg"
