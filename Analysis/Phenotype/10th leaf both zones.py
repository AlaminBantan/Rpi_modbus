...
ax = sns.boxplot(x=df['Date'].dt.date, y='IN Length 10  (cm)', hue='Treatment', data=df, palette=custom_palette)
plt.title('Distance of the 10th leaf')
plt.xlabel('Date')
...
output_filename = "distance_10th.svg.svg"
