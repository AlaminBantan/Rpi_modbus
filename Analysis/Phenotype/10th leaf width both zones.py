...
ax = sns.boxplot(x=df['Date'].dt.date, y='Leaf width 10 (cm)', hue='Treatment', data=df, palette=custom_palette)
plt.title('Width of the 10th leaf')
plt.xlabel('Date')
plt.ylabel('Width (cm)')
...
output_filename = "width_10th.svg.svg"
