...
ax = sns.boxplot(x=df['Date'].dt.date, y='Stem elongation (cm)', hue='Treatment', data=df, palette=custom_palette)
plt.title('Stem elongation ')
plt.xlabel('Date')
...
output_filename = "stem_elongation.svg"
