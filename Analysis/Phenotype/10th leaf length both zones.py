...
ax = sns.boxplot(x=df['Date'].dt.date, y='Leaf length 10 (cm)', hue='Treatment', data=df, palette=custom_palette)
plt.title('Length of the 10th leaf')
plt.xlabel('Date')
...
output_filename = "length_10th.svg.svg"
